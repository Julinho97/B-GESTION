...
<html lang="en" dir="ltr">
  <head>
    <title>Profiling and Bamsasin Management System</title>
  </head>
  <body class="">
             ...
             <!--  <div class="col-sm-6 col-lg-3">
              ...
              <div style="padding-left: 12px; padding-bottom: 25px;" class="">
                <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#modal-filter-date">
                   <i class="fe fe-filter mr-2"></i> Filter Bamsasin
                </button>
              ...
              <div style="padding-left: 12px; padding-bottom: 25px;" class="dropdown">
                <button type="button" class="btn btn-secondary  " onclick="printPage()">
                   <i class="fe fe-list mr-2"></i> Print Bamsasin
                </button>
                <div class="dropdown-menu">
                </div>
              </div>  
...
function printPage(){
    ...
    document.body.innerHTML="<link rel='stylesheet' href='css/common.css' type='text/css' /><body class='bodytext'><div class='padding'><b style='font-size: 16px;'><p class=''>Bamsasin generated on <?php echo date("m/d/Y") ?> <?php echo date("G:i A") ?> by <?php echo $firstname ?> <?php echo $lastname ?></p></b></div>"+divElements+"</body>";
    window.print();
              ...
              <div class="col-12" id="printDataHolder">
                ...
                <div class="card">
                  <div class="card-header py-3">
                    <h3 class="card-title">Bamsasin From <b><?php echo date('M d, Y', strtotime($from)) ?>&nbsp(<?php echo date('D', strtotime($from)) ?>) </b>To <b><?php echo date('M d, Y', strtotime($to)) ?>&nbsp(<?php echo date('D', strtotime($to)) ?>)</b></h3>
                  </div>
                  <div class="card-body">
                        ...
                        <thead>
                          <tr>
                           ...
                           <!--  <th>Position</th> -->
                            ...
                            <th> REVENU BRUT(F CFA)</th>                          
                            <th> AVANCE DE TRÉSORERIE(   F CFA)</th>
                            <th>HEURES TOTALES</th>
                            <th>REVENU NET (F CFA)</th>
                            <th>FICHE DE PAIE</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php 
                          // Calculating the Bamsasin from SAT - FRI (7 Days)
                          ...
                          $sqlBamsasin = mysqli_query($connection, $sql);
                          $total = 0;

                          $numbers = 0;

                          while($row = mysqli_fetch_assoc($sqlBamsasin)){
                          ...
                          <tr>
                            ...
                            <div class="item-action dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a href="payslip.php?id=<?php echo $row['employee_id'] ?>" class="dropdown-item"><i class="dropdown-icon fe fe-eye"></i> View</a>
                              </div>
                            </div>
                          </td>
                          </tr>
