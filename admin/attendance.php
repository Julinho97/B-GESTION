            ...
            <div style="padding-left: 12px; padding-bottom: 25px;">
              <div class="dropdown  ">
                <button type="button" style="background-color: " class="btn btn-secondary dropdown-toggle" data-toggle="dropdown">
                  <i style="padding-top: 10px;" class="fe fe-clock mr-2"></i> Ajouter une Participation</button>

                <div style="padding-top: 10px;" class="dropdown-menu">
                  <button data-toggle="modal" data-target="#modal-add-attendance-in" class="dropdown-item ">Ajouter de l'heure d'entrée</button>
                  <button data-toggle="modal" data-target="#modal-add-attendance-out" class="dropdown-item ">Ajouter un délai d'ettente</button>
                </div>
              ...
              <div style="padding-left: 12px;" class="dropdown  ">
                <button type="button" style="background-color: " data-toggle="modal" data-target="#modal-filter-attendance" class="btn btn-secondary">
                  <i style="padding-top: 10px;" class="fe fe-filter mr-2"></i> Filter la Date</button>


              </div>
              <div style="padding-left: 12px;" class="dropdown">
                <button type="button" style="background-color:" class="btn btn-secondary" onclick="printPage()">
                  <i style="padding-top: 10px;" class="fe fe-printer mr-2"></i> Présence à l'impression</button>


              </div>
              <div style="padding-left: 12px;" class="dropdown  ">
                <a target="_blank" href="../index.php"><button type="button" style="background-color: " class="btn btn-secondary">
                    <i style="padding-top: 10px;" class="fe fe-grid mr-2"></i> Use -barrescode</button></a>
              ...
              <div style="padding-left: 420px; float: right" class="dropdown ">
                <button data-toggle="modal" data-target="#modal-show-attendance" type="button" style="background-color: " class="btn btn-secondary ">
                  <i style="padding-top: 10px;" class="fe fe-eye mr-2"></i> Afficher tout</button>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header py-3">
                  <h3 class="card-title">Tableau de présance pour le <b><?php echo date('F d, Y', strtotime($today)) ?></b></h3>
                </div>
                    ...
                    <table class="table table-hovered" id="dataTable" cellspacing="5">
                      <thead>
                        <tr>
                          ...
                          <th>Heure AM</th>
                          <th>Délai d'expiration AM</th>
                          <th>Temps Total </th>
                          <th>Timein PM</th>
                          <th>Délai d'expiration PM</th>
                          <th>Temps Total </th>
                          <th>date</th>
                          <th>action</th>
