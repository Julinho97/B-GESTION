...
<html lang="en" dir="ltr">
  <head>
    <title>Profiling and B-rappel Management System</title>
  </head>
  <body class="">
                ...
                <div class="table-responsive push">
                  <table class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td class="text-right"><?php echo  number_format($gross) ?> F CFA</td>
                    </tr>
                    <tr>
                      <td colspan="4" class="font-w600 text-right">Cash Advance</td>
                      <td class="text-right">-<?php echo  number_format($cashadvance) ?> F CFA</td>
                    </tr>  
                    <tr>
                      <td colspan="4" class="font-w600 text-right">Overtime</td>
                      <td class="text-right"><?php echo  number_format($ot) ?> F CFA</td>
                    </tr>   
                                        <tr>
                      <td colspan="4" class="font-w600 text-right">Net Income (Gross Income - Cash Advance)</td>
                      <td class="text-right"><b><?php echo  number_format($net_pay) ?> F CFA</b> </td>
                    </tr>                                    
                    <tr color="dark">
                      <td colspan="4" class="font-weight-bold text-uppercase text-right">NET PAY (Net Income + Overtime)</td>
                      <td class="text-right"><strong><?php echo  number_format($net_pay + $ot) ?>  F CFA </strong></td>
                    </tr>
                  </table>
                </div>
